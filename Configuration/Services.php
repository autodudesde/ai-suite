...
return function (ContainerConfigurator $configurator, ContainerBuilder $containerBuilder) {
    ...
    $services->set(\AutoDudes\AiSuite\EventListener\ProvenancePublishListener::class)
        ->tag('event.listener', [
            'method' => '__invoke',
            'event' => \TYPO3\CMS\Workspaces\Event\AfterRecordPublishedEvent::class,
            'identifier' => 'tx-ai-suite/provenance-after-record-published'
        ]);

    $services->set(\AutoDudes\AiSuite\EventListener\RegisterProvenancePreviewRendererListener::class)
        ->tag('event.listener', [
            'method' => '__invoke',
    ...
    $services->set(\AutoDudes\AiSuite\EventListener\LoadCreditsToolbarListener::class)
        ->tag('event.listener', [
            'method' => '__invoke',
            'event' => \TYPO3\CMS\Backend\Controller\Event\AfterBackendPageRenderEvent::class,
