...
class AiSeoTwitterDescription extends AbstractNode
{
    ...
    public function render(): array
    {
        ...
        return [
            ...
            'title' => GeneralUtility::makeInstance(LocalizationService::class)->translate('LLL:EXT:ai_suite/Resources/Private/Language/locallang.xlf:aiSuite.generation.twitterDescriptionSuggestions'),
            'linkAttributes' => [
