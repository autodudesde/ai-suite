...
class TranslationService
{
    ...
    public function fetchTranslationFields(array $defaultValues, int $ceSrcLangUid, string $table): array
    {
        $formData = $this->getFormData($defaultValues, $ceSrcLangUid, $table);
    ...
    protected function getFormData(array $defaultValues, int $ceSrcLangUid, string $table)
    {
