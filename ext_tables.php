...
$GLOBALS['TYPO3_CONF_VARS']['BE']['customPermOptions']['tx_aisuite_features'] = [
    ...
    'items' => [
        ...
        'enable_auto_translation' => [
            'LLL:EXT:ai_suite/Resources/Private/Language/locallang_tca.xlf:aiSuite.permissions.enableAutoTranslation',
            'tx-aisuite-permissions',
            'LLL:EXT:ai_suite/Resources/Private/Language/locallang_tca.xlf:aiSuite.permissions.enableAutoTranslationDescription',
        ],
        ...
        'enable_cli_workflow_execution' => [
            'LLL:EXT:ai_suite/Resources/Private/Language/locallang_tca.xlf:aiSuite.permissions.enableCliWorkflowExecution',
            'tx-aisuite-permissions',
        ...
        'enable_statistics' => [
            ...
            'tx-aisuite-permissions',
            'LLL:EXT:ai_suite/Resources/Private/Language/locallang_tca.xlf:aiSuite.permissions.enableStatisticsDescription',
        ],
    ],
];
