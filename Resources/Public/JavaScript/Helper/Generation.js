define([
    ...
    Generation.prototype.addFormSubmitEventListener = function(promptInputName) {
    ...
    Generation.prototype.showSpinner = function() {
    ...
    Generation.prototype.hideSpinner = function() {
    ...
    Generation.prototype.showSpinnerModal = function(message, height = 400) {
    ...
    Generation.prototype.cancelGeneration = function() {
    ...
    Generation.prototype.languageSelectionEventListener = function() {
        const self = this;
    ...
    Generation.prototype.checkLanguageSelection = function(languageSelections) {
