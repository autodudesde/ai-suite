define([
        ...
        document.querySelectorAll('.ai-suite-suggestions-generation-btn').forEach(function(button) {
            button.addEventListener("click", function(ev) {
                ...
                if(
                    ...
                    Ajax.sendMetadataAjaxRequest(sysFileMetadataId, fieldName, postData, handleResponse, '', addSelectionToAdditionalFields);
                } else {
                    let pageId = parseInt(this.getAttribute('data-page-id'));
                    let postData = {
                        pageId: pageId
                    };
                    Ajax.sendMetadataAjaxRequest(pageId, fieldName, postData, handleResponse, '', addSelectionToAdditionalFields);
                }
            });
        });
    }
    ...
    function addSelectionToAdditionalFields(pageId, fieldName, selectedSuggestionValue) {
