...
class GptImageContentElement {
    constructor() {
        this.intervalId = null;
    }
    addImageGenerationWizard(data) {
        let self = this;
        MultiStepWizard.addSlide('ai-suite-gpt-image-generation-step-1', TYPO3.lang['aiSuite.module.modal.imageSelection'], '', Severity.notice, TYPO3.lang['aiSuite.module.modal.gptImageSlideOne'], async function (slide, settings) {
            ...
            slide.html(Generation.showSpinnerModal(TYPO3.lang['aiSuite.module.modal.imageGenerationInProcessGptImage'], 705));
            ...
            Promise.all([self.generateImage(data), StatusHandling.fetchStatus(data, modal, self)])
                .then(([res, status]) => {
                    ...
                    ResponseHandling.handleResponseContentElement(res, data, TYPO3.lang['aiSuite.module.modal.gptImageSelectionError']);
                })
                .catch(error => {
                    clearInterval(self.intervalId);
                });
...
export default new GptImageContentElement();
