class Metadata {
     ...
     */
    insertSelectedSuggestions(model, modelId, fieldName, selectedSuggestion, addToAdditionalFields = false, addSelectionToAdditionalFields = null) {
     ...
     */
    addRemoveButtonListener(selection) {
