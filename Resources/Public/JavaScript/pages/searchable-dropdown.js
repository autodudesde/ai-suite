var searchableInputList = Array.from(document.querySelectorAll('.searchable.dropdown ul li input.searchableInput'));
if (Array.isArray(searchableInputList)){
    searchableInputList.forEach(function(item, index, arr){
        item.addEventListener('keyup', function(){
            ...
            li = dropdownElement.getElementsByTagName('li');
...
var searchableOptionList = Array.from(document.querySelectorAll('.searchable.dropdown ul li a'));
